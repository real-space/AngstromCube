...
#undef  INDICES
    ...
    size_t multiply(
        ...
        , double   const hgrid[] // grid spacing, ToDo make it an array of X,Y,Z
        ...
        for (int dd = 0; dd < 3; ++dd) { // derivative direction
            ...
            Laplace_driver<real_t,R1C2,Noco>(Tpsi, psi, list, f, {16, int(num[dd]), 1}, {Noco*64, Noco, R1C2}, Stride, nFD[dd]);
