...
namespace simple_math {
  ...
  template<typename T>
  T inline determinant(T a00, T a01, T a10, T a11) {
  ...
  template<typename T>
  T inline determinant(T a00, T a01, T a02, T a10, T a11, T a12, T a20, T a21, T a22) {
  ...
  template<typename T>
  T inline determinant(T a00, T a01, T a02, T a03, T a10, T a11, T a12, T a13, 
  ...
  template<typename T>
  T inline determinant(int const n, T const a[], int const as) {
...
//             printf("# i=%d i1=%d i2=%d j=%d j1=%d j2=%d\n", i, i1, i2, j, j1, j2);
  ...
  template<typename T>
  T inline invert(int const n, T inv[], int const is, T const a[], int const as) {
