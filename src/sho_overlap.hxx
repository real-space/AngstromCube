...
namespace sho_overlap {
  ...
  status_t moment_tensor(real_t tensor[], // tensor layout [1 + maxmoment][n1][n0]
  ...
  status_t overlap_matrix(real_t matrix[], // matrix layout [n1][n0]
                     double const distance,
                     int const n1, int const n0,
                     double const sigma1,   // =1
                     double const sigma0) { // =1
  ...
  status_t nabla2_matrix(real_t matrix[], // matrix layout [n1][n0]
                     double const distance,
                     int const n1, int const n0,
                     double const sigma1,   // =1
                     double const sigma0) { // =1
  ...
  template<typename real_t>
  status_t product_tensor(real_t tensor[], int const n, // tensor layout [2*n-1][n][n]
