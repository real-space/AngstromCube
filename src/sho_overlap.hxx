...
namespace sho_overlap {
  ...
  status_t overlap_matrix(real_t matrix[], // matrix layout [][n0]
                     double const distance,
                     int const n0, int const n1, 
  ...
  template<typename real_t> inline
  status_t nabla2_matrix(real_t matrix[], // matrix layout [][n0]
                     double const distance,
                     int const n0, int const n1, 
                     double const sigma0,   // =1
                     double const sigma1) { // =1
    return moment_tensor(matrix, distance, n0, n1, sigma0, sigma1, -2);
  } // nabla2_matrix
