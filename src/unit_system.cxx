...
namespace unit_system {
    ...
    double energy_unit(char const *which, char const **const symbol) {
    ...
    double length_unit(char const *which, char const **const symbol) {
        char const w = which[0] | 32; // take first char and ignore case
    ...
    status_t set(char const *length, char const *energy, int const echo) {
        ...
        // this is the only point where these global variables from display_units.h may be modified
