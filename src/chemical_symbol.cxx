...
namespace chemical_symbol {
  ...
  int8_t get(char Sy[4], double const Z, char const blank) {
      ...
      char const S = element_symbols[2*z7 + 0];
  ...
  // strategy: combine both printable ASCII char S,y into one 16bitnumber
  ...
  int8_t decode(char const S, char const y) {
      switch  (encode_16bit( S,  y )) 
      {
          ...
          case encode_16bit('u','t'): return 113; // "ut"
          case encode_16bit('u','q'): return 114; // "uq"
          case encode_16bit('u','p'): return 115; // "up"
          case encode_16bit('u','h'): return 116; // "uh"
          case encode_16bit('u','s'): return 117; // "us"
          case encode_16bit('u','o'): return 118; // "uo"
          case encode_16bit('u','n'): return 119; // "un"
          case encode_16bit('u','d'): return 120; // "ud"
