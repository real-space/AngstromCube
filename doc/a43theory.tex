...
of the 2x2 matrix which is LU-decomposed in the Gram-Schmidt orthogonalization procedure
...
Using projector functions from Bloechls approach, SHO-filtering allows to represent
these functions as a linear combination of two radial SHO eigenfunctions.

This together leads to a set of partial waves and projectors
that produce an almost singular PAW overlap operator $\mathcal S$:
\begin{align}
...
\begin{figure} [ht]
  ...
  to a singular eigenvalue of the PAW overlap operator.
