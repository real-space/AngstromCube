...
and inside the spheres for both, smooth and true quantities.
...
\begin{figure}
  ...
  The shifted (solid lines) and a Bessel projection of the 3D solution match inside the spheres (radii 2 Bohr).}
\end{figure}
%
%
