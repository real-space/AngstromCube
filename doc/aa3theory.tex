...
compensator charges are used.
These also follow the Gaussian decay %% reference needed, e.g. GPAW
...
Different from the L2-normalization, the normalization for electrostatics is given by
$$ 1 = \int \mathrm d\vec r^3  \  \hat q_{\ell m}(\vec r) Y_{\ell m} |\vec r|^\ell $$
