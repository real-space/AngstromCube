...
Usage ./a43 [OPTIONs] [<file>]
   ...
   +<name>=<value>     	Overwrite variable environment\end{verbatim}
...
We can pass more environment variables to \codename{}\emph{control file}, e.g.:
\begin{verbatim}
./a43 control.sh --test self_consistency
\end{verbatim}
