...
\todo[inline]{Change only at compile time possible. Make them runtime-configurable}
...
\todo[inline]{Keywords to change it?}
...
\todo[inline]{Add MIT license header}
...
\todo[inline]{make the path to pot/ dynamic}
...
\begin{verbatim}
./aa3 +verbosity=7 -t single_atom. +single_atom.test.Z=13 +logder.start=-4 +logder.step=1e-4 +logder.stop=1.0
\end{verbatim}
